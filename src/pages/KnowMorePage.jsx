...
const tabData = {
  strategy: {
    ...
    paragraph1:
      "We transform complexity into clarity, building actionable roadmaps that ensure every decision, campaign, and initiative is aligned with your business goals. Without a clear strategy, even the strongest ideas risk losing momentum. That's why we make it our mission to create direction, eliminate guesswork, and unlock opportunities others overlook.",
    paragraph2:
    ...
    paragraph3:
      "At Altecht, strategy isn’t just guidance—it’s a growth blueprint that keeps your brand secure, agile, and future-ready.",
    sammary:
  ...
  cybersecurity: {
    ...
    paragraph1:
      "At the core of our cybersecurity services is a commitment to building secure digital ecosystems that safeguard your data, infrastructure, and operations. We focus on proactive measures, implementing solutions that evolve with emerging threats while maintaining compliance with global security standards.",
    paragraph2:
      "Our process begins with a comprehensive risk assessment, including vulnerability scanning, threat modeling, and compliance checks. We collaborate with your team to design security frameworks aligned with your business needs whether it’s endpoint protection, cloud security, or incident response planning.",
    paragraph3:
      "By leveraging the latest security technologies and best practices, we deliver solutions that not only protect but also empower growth. From security audits to employee training and continuous monitoring, our approach ensures that your business remains secure, agile, and future-ready.",
    sammary:
  ...
  talentAcquisition: {
    ...
    paragraph1:
      "At the heart of our talent acquisition services is a focus on finding, attracting, and retaining top-tier tech talent that aligns with your company’s culture and growth goals. We specialize in crafting data-driven hiring strategies that streamline recruitment and deliver high-quality results.",
    paragraph2:
      "Our process begins with a deep analysis of your hiring needs, from workforce planning and skill-gap assessments to employer branding. We then create tailored recruitment strategies, leveraging technology, automation tools, and industry expertise to ensure speed, accuracy, and scalability.",
    paragraph3:
      "By integrating market insights and innovative sourcing methods, we deliver a talent pipeline that supports your long-term success. From IT staffing to leadership hiring, our approach ensures you have the right people in the right roles—ready to build, innovate, and grow with your business.",
    sammary:
